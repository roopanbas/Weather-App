              ...
              children: [
                Container(
                 ...
                 child: ListTile(
                  ...
                  titleTextStyle: const TextStyle(color: kWhite,fontWeight: FontWeight.bold,fontSize: 26),
                  subtitleTextStyle: const TextStyle(color: kGrey),
                  trailing: IconButton(onPressed: (){}, icon:const Icon(Icons.refresh),color: kGrey,),
                 ),
                ),
                CurrentWeatherCard(),
                Container(
